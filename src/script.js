...
function createPattern6(){
  ...
  graph.registHub(posX, posY);
  let inHubsId = [0, 2, 3, 5, 7, 7, 9, 10, 12, 14, 15, 18, 19, 20, 21, 17, 6, 1, 7, 18, 4, 8, 10, 10, 14, 16, 16, 11, 11, 13, 22, 23, 3, 24, 25];
  let outHubsId = [1, 1, 2, 4, 6, 8, 10, 11, 13, 13, 16, 17, 18, 19, 20, 9, 15, 7, 12, 12, 13, 5, 8, 14, 19, 2, 20, 3, 21, 22, 23, 0, 24, 25, 0];
